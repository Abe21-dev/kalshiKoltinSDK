...
private fun createSignature(privateKey: PrivateKey, timeStamp: Long, method: String, path: String): String {
...
fun getApiHeader(filePath: String, apiKey: String, apiRequestType: ApiRequestType, path: String): Map<String, String> {
    val timestamp = System.currentTimeMillis()
    val privateKey = loadPrivateKey(filePath)
    val signature = createSignature(privateKey, timestamp, apiRequestType.toString(), path)
    val headers = mapOf("KALSHI-ACCESS-KEY" to apiKey,
